...
// // Update the DailyDiscovery component to handle play/pstate correctly
// const DailyDiscovery = ({ songs, playPlaylist, playSong, likedSet, toggleLike, currentSong, isPlaying, togglePlayPause, handleRipple }) => {
//   const { isDarkMode } = useTheme();
...
//       togglePlayPause();
//     } else {
//       trackPlayCount(song._id); // Track play count
//       playSong(song, songsList);
//     }
//     if (e) handleRipple(e);
...
//       // Sort songs by play count (most played first)
...
//       // Also consider liked songs
//       const sortedByLikes = [...songs].sort((a, b) => {
//         const aLiked = likedSongIds.includes(a._id) ? 1 : 0;
//         const bLiked = likedSongIds.includes(b._id) ? 1 : 0;
...
//       return songs.slice(0, 6); // Fallback
//     }
//   }, [songs, likedSet]);
...
//     return [...songs].reverse().slice(0, 18);
//   }, [songs]);
...
// const VibeToday = ({ songs, playSong, handleRipple, currentSong, isPlaying, togglePlayPause }) => {
//   const { isDarkMode } = useTheme();
...
// const RecentlyLiked = ({ songs, likedSet, playSong, toggleLike, currentSong, isPlaying, togglePlayPause, handleRipple }) => {
//   const { isDarkMode } = useTheme();
//   const likedSongs = songs.filter((s) => likedSet.has(s._id)).slice(-6).reverse();
...
//                 whileHover={{ x: 5 }}
//               >
//                 <div className="relative" onClick={(e) => handlePlayAction(s, e)}>
...
//                 <div className="flex-1 min-w-0" onClick={(e) => handlePlayAction(s, e)}>
//                   <div className={`font-semibold leading-tight line-clamp-1 ${
//                     isDarkMode ? "text-white" : "text-gray-900"
//                   }`}>{s.title}</div>
//                   <div className={`text-sm leading-tight line-clamp-1 ${
...
// // Language Section
// const LanguageSection = ({ songsByLanguage, playPlaylist, isDarkMode, setQuery }) => {
//   const languages = [
//     { name: "Hindi", color: "bg-red-500" },
//     { name: "Odia", color: "bg-blue-500" },
//     { name: "Tamil", color: "bg-yellow-500" },
...
//               }`}
//               whileHover={{ y: -5, scale: 1.02 }}
//               onClick={() => setQuery(language.name)}
//             >
//               <div className={`w-12 h-12 rounded-full ${language.color} flex items-center justify-center text-white font-bold text-lg mb-3`}>
//                 {language.name.charAt(0)}
//               </div>
...
// // Genre Section
// const GenreSection = ({ songsByGenre, playPlaylist, isDarkMode, setQuery }) => {
//   const genres = [
//     { name: "Lofi", color: "bg-blue-400", icon: "🎵" },
//     { name: "Instagram Bits", color: "bg-pink-400", icon: "📱" },
//     { name: "Instrumental", color: "bg-purple-400", icon: "🎻" },
...
// // Mood Section
// const MoodSection = ({ songsByMood, playPlaylist, isDarkMode, setQuery }) => {
//   const moods = [
//     { name: "Travelling", color: "bg-yellow-400", icon: "✈️" },
//     { name: "Sleeping", color: "bg-indigo-400", icon: "😴" },
//     { name: "Enjoy", color: "bg-green-400", icon: "😄" },
...
//   const [loading, setLoading] = useState(true);
//   const { isDarkMode } = useTheme();
//   const [view, setView] = useState("home"); // 'home' or 'category'
...
//       playSong(song, songsList);
//     }
//   }, [currentSong, playSong, togglePlayPause, trackPlayCount]);
...
//   const handleCategorySelect = (type, name, songsList) => {
...
//             <SearchResults
//               results={filteredResults}
//               onPlay={(s, q, e) => { playSong(s, q); }}
//               onToggleLike={(id, e) => { (likedSet.has(id) ? unlikeSong(id) : likeSong(id)); }}
//               likedSet={likedSet}
//             />
//           </motion.div>
//         ) : view === "category" ? (
...
//               songs={categorySongs}
//               playPlaylist={() => playPlaylist(categorySongs)}
//               playSong={handlePlayAction}
//               likedSet={likedSet}
//               toggleLike={handleToggleLike}
//               currentSong={currentSong}
...
// // Language Section
// const LanguageSection = ({ songsByLanguage, onCategorySelect, isDarkMode }) => {
//   const languages = [
//     { name: "Hindi", color: "bg-red-500" },
//     { name: "Odia", color: "bg-blue-500" },
//     { name: "Tamil", color: "bg-yellow-500" },
...
//               }`}
//               whileHover={{ y: -5, scale: 1.02 }}
//               onClick={() => onCategorySelect("language", language.name, songs)}
//             >
//               <div className={`w-12 h-12 rounded-full ${language.color} flex items-center justify-center text-white font-bold text-lg mb-3`}>
//                 {language.name.charAt(0)}
//               </div>
...
// // Genre Section
// const GenreSection = ({ songsByGenre, onCategorySelect, isDarkMode }) => {
//   const genres = [
//     { name: "Lofi", color: "bg-blue-400", icon: "🎵" },
//     { name: "Instagram Bits", color: "bg-pink-400", icon: "📱" },
//     { name: "Instrumental", color: "bg-purple-400", icon: "🎻" },
...
//               }`}
//               whileHover={{ y: -5, scale: 1.02 }}
//               onClick={() => onCategorySelect("genre", genre.name, songs)}
//             >
//               <div className={`w-12 h-12 rounded-full ${genre.color} flex items-center justify-center text-white text-2xl mb-3`}>
//                 {genre.icon}
//               </div>
...
// // Mood Section
// const MoodSection = ({ songsByMood, onCategorySelect, isDarkMode }) => {
//   const moods = [
//     { name: "Travelling", color: "bg-yellow-400", icon: "✈️" },
//     { name: "Sleeping", color: "bg-indigo-400", icon: "😴" },
//     { name: "Enjoy", color: "bg-green-400", icon: "😄" },
...
//               }`}
//               whileHover={{ y: -5, scale: 1.02 }}
//               onClick={() => onCategorySelect("mood", mood.name, songs)}
//             >
//               <div className={`w-12 h-12 rounded-full ${mood.color} flex items-center justify-center text-white text-2xl mb-3`}>
//                 {mood.icon}
//               </div>
...
// const SongCarousel = ({ title, songs, autoPlay = false, CardComponent, currentSong, isPlaying, togglePlayPause }) => {
//   const { playSong, likedSongs, likeSong, unlikeSong } = useContext(PlayerContext);
//   const { isDarkMode } = useTheme();
//   const likedSet = useMemo(() => new Set(likedSongs), [likedSongs]);
