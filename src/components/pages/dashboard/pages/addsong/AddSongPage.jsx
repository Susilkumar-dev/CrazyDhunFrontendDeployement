    ...
    const handleSongUpload = async (e) => {
        ...
        try {            
            ...
            const { data } = await axios.post(
                `${import.meta.env.VITE_API_URL}/user/songs/request`,
                formData,
                config
            );
            
            setMessage(`Song uploaded successfully! Awaiting admin approval.`);
            ...
            if (err.response?.status === 404) {
                setError('Server endpoint not found. Please check your backend configuration.');
                ...
                setError('Upload failed. Please check your backend server logs.');
            }
        } finally {
            setLoading(false);
        }
