...
const AddSongPage = () => {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      // Fixed endpoint - user should request song upload, not admin endpoint
      ...
      setMessage(data.message || `Song '${title}' submitted for approval!`);
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <p className={`text-lg ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            Submit a song for admin approval
          </p>
        </motion.div>
