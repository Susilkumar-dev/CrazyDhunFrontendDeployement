...
const PlayerControls = ({ onPlayerOpen }) => {
  ...
  return (
    <div className="fixed bottom-16 md:bottom-0 left-0 right-0 bg-gradient-to-r from-purple-900/80 via-black to-cyan-900/80 backdrop-blur-lg border-t border-purple-700/40 shadow-[0_-2px_20px_rgba(0,0,0,0.8)] z-50">
...
//       {/* ✅ YouTube-like Slim Progress Bar (FULLY functional + draggable) */}
...
//         {/* Center: Main Controls */}
//         <div className="w-1/2 flex flex-col items-center px-1 sm:px-2">
//           <div className="flex items-center space-x-3 sm:space-x-5 text-gray-400">
//             <button onClick={playPreviousSong} disabled={!hasPrev}
//               className="hover:text-cyan-400 disabled:opacity-50 disabled:cursor-not-allowed transition">
//               <FaStepBackward size={18} />
//             </button>
